...
class Pest {
  ...
  public function post($url, $data, $headers=array()) {
    ...
    // echo($data);
    // exit();
    // $data = 'SETTLEMENT_TYPE=01&MERCHANT_ID=sample1&ORDER_ID=43XgR&SESSION_ID=539185c98a44cd94fec86a5110075b65&GROSS_AMOUNT=20&PREVIOUS_CUSTOMER_FLAG=1&CUSTOMER_STATUS=&MERCHANTHASH=e03ed96bd49922518f8563a8d586126779ae06febbdd56069f59d315feb8b261b1aea72ddd604b61dea8f0dc1f8934620ee476e56243b4a481a3635484ca32a6&SHIPPING_INPUT_FLAG=1&SHIPPING_SPECIFICATION_FLAG=1&SHIPPING_ADDRESS1=oke&SHIPPING_ADDRESS2=Minatoku&SHIPPING_CITY=Tokyo&SHIPPING_COUNTRY_CODE=JPN&SHIPPING_POSTAL_CODE=1606028&SHIPPING_PHONE=03111122229&CARD_NO=4111111111111111&CARD_EXP_DATE=11%2F14&FINISH_PAYMENT_RETURN_URL=http%3A%2F%2F192.168.10.228&UNFINISH_PAYMENT_RETURN_URL=http%3A%2F%2F192.168.10.228&ERROR_PAYMENT_RETURN_URL=http%3A%2F%2F192.168.10.228&LANG_ENABLE_FLAG=&LANG=&REPEAT_LINE=2&COMMODITY_ID=IDxx12&COMMODITY_UNIT=10&COMMODITY_NUM=1&COMMODITY_NAME1=Waterbostle&COMMODITY_NAME2=Waterbotstle+in+Indonen1&COMMODITY_ID=IDxx22&COMMODITY_UNIT=10&COMMODITY_NUM=1&COMMODITY_NAME1=Watere&COMMODITY_NAME2=Waterbotstle+in';
    $data = 'SETTLEMENT_TYPE=01&MERCHANT_ID=sample1&ORDER_ID=CdgkF&SESSION_ID=11cd3c131883a6c74080beb8124b288e&GROSS_AMOUNT=10&PREVIOUS_CUSTOMER_FLAG=1&CUSTOMER_STATUS=&MERCHANTHASH=7d7aaf6705375999a561d97ae5de5ccdd210013ae8301ca2882448878fa399f645f3e5d378044790c28fde23c019cf4b56f42dfb63fd437fa85dc76ff50c3184&SHIPPING_INPUT_FLAG=1&SHIPPING_SPECIFICATION_FLAG=1&SHIPPING_ADDRESS1=oke&SHIPPING_ADDRESS2=Minatoku&SHIPPING_CITY=Tokyo&SHIPPING_COUNTRY_CODE=JPN&SHIPPING_POSTAL_CODE=1606028&SHIPPING_PHONE=03111122229&CARD_NO=4111111111111111&CARD_EXP_DATE=11/14&FINISH_PAYMENT_RETURN_URL=http://192.168.10.228&UNFINISH_PAYMENT_RETURN_URL=http://192.168.10.228&ERROR_PAYMENT_RETURN_URL=http://192.168.10.228&LANG_ENABLE_FLAG=&LANG=&REPEAT_LINE=1&COMMODITY_ID=IDxx12&COMMODITY_UNIT=10&COMMODITY_NUM=1&COMMODITY_NAME1=Waterbostle&COMMODITY_NAME2=Waterbotstle+in+Indonen1';
    // exit();

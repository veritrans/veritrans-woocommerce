...
# empty cart should be after notification or redirection
    ...
    /**
       ...
       */
    class WC_Gateway_Veritrans_Bcainstallment extends WC_Payment_Gateway {

      /**
       * Constructor
       */
      function __construct() {
        $this->id           = 'veritrans_bcainstallment';
        $this->icon         = apply_filters( 'woocommerce_veritrans_icon', '' );
        $this->method_title = __( 'Veritrans Bca Installment', 'colabsthemes' );
        $this->has_fields   = true;
        $this->notify_url   = str_replace( 'https:', 'http:', add_query_arg( 'wc-api', 'WC_Gateway_Veritrans_Bcainstallment', home_url( '/' ) ) );
      ...
      function init_form_fields() {
        ...
        $this->form_fields = array(
          'enabled' => array(
            ...
            'type' => 'checkbox',
            'label' => __( 'Enable Veritrans BCA installment Payment', 'woocommerce' ),
            'default' => 'no'
          ),
          'title' => array(
            ...
            'default' => __( 'Bca Credit Card installment', 'woocommerce' ),
            'desc_tip'      => true,
          ),
          'description' => array(
            ...
            'default' => 'Minimal transaction amount allowed for credit card offline installment is Rp. '.$this->get_option( 'min_amount' ). '</br> You will be redirected to fullpayment page if the transaction amount below this value'
          ),
          ...
          'installment_terms' => array(
            ...
            'type' => 'text',
            'label' => __( 'Installment terms', 'woocommerce' ),
          ...
          'enable_bin_filter' => array(
            ...
            'description' => __( 'Filled with BCA bin numbers.', 'woocommerce' ),
            'default' => '4,5'
          ),
          'min_amount' => array(
      ...
      function charge_payment( $order_id ) {
        ...
        $params['vtweb']['credit_card']['bank'] = 'bca';
        $params['vtweb']['credit_card']['channel'] = 'migs';
        ...
        $installment_terms['bca'] = $term_array;

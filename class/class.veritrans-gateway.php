...
class WC_Gateway_Veritrans extends WC_Payment_Gateway {
	...
	const VT_REQUEST_KEY_URL = 'https://vtweb.veritrans.co.id/web1/commodityRegist.action';
	const VT_PAYMENT_REDIRECT_URL = 'https://vtweb.veritrans.co.id/web1/paymentStart.action';
  ...
  function charge_payment( $order_id ) {
	...
	private function generate_veritrans_form($order_id,$token_browser) {
